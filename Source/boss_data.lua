...
-- ======================================================================
    ...
    ["BOSS4"] = {
        ...
        rig = {
            ...
            nose_mask = { cell = 5 },
            -- ★ 2026-09-25 (26,60)→(22,52)：再往左上一點，看起來才像**從機鼻黑色處拋出來**。
            --   ⚠️ 這是 crate 的**左上角**（Stone 以左上角繪製、crate 24×19）→ 它佔 x22~46 / y52~71，
            --     完全落在第 5 格遮罩（x19~53 / y50~73）之內，停留那 0.3 秒才是真的被遮住。
            throw     = { x = 22, y = 52 },                         -- 機鼻黑色處
        },
