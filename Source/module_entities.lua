...
--   entity_boss_parallel.lua  §15.5a 平行零件制 BOSS（巨大 BOSS）；把方法掛到 Enemy 上
--   entity_boss_hover.lua  §15.5c 懸停轟炸機 BOSS（本體一條血 + 可修復的機槍）；同上
...
import "entity_boss_hover"      -- [[ §15.5c ]] 懸停轟炸機 BOSS（同上）
import "entity_stone"
import "entity_mech"
